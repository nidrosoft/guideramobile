...
export default function Welcome2() {
  ...
  const handleNext = () => {
    ...
    router.push('/(onboarding)/welcome-3' as any);
  };
      ...
      <BlurView intensity={80} tint="light" style={styles.bottomContainer}>
        <View style={styles.content}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.title}>Book It All in One Place</Text>
            <Text style={styles.description}>
              Flights, hotels, car rentals, and experiences - all seamlessly integrated in one app.
            </Text>
          </View>
