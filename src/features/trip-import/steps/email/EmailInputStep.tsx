 ...
 * EMAIL INPUT STEP
 * 
 * Step 4 in email import flow - Manual email entry for "Other Provider".
...
export default function EmailInputStep({ onNext, data }: StepComponentProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.securityNote}>
        ...
        <Text style={styles.securityText}>
          Your credentials are encrypted and securely stored. We never share your information.
        </Text>
      </View>
