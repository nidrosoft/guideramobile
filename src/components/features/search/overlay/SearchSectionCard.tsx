...
export default function SearchSectionCard({
  ...
  const cardBg = isDark ? '#1A1A1A' : themeColors.bgElevated;
  ...
  if (!isExpanded) {
    return (
      <TouchableOpacity
        style={[styles.collapsedCard, { backgroundColor: cardBg, borderWidth: 1, borderColor: themeColors.borderSubtle }]}
        onPress={onPress}
        activeOpacity={0.8}
      >
  ...
  return (
    <View style={[styles.expandedCard, { backgroundColor: cardBg, borderWidth: 1, borderColor: themeColors.borderSubtle }]}>
